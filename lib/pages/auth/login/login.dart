                  ...
                  child: Column(
                    children: [
                      ...
                      Align(
                        alignment: Alignment.centerLeft,
                        child: Text(
                          AppConstant.LOGIN_HEAD_TEXT_PASSWORD,
                          style: GoogleFonts.openSans(
                            textStyle: Theme.of(context).textTheme.displayLarge,
                            fontSize: width * 0.045,
                            fontStyle: FontStyle.normal,
                              ...
                              child: Center(
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    contentPadding: EdgeInsets.only(left: width * 0.03, top: height * 0.015),
                                    suffixIcon: IconButton(
                                      onPressed: () {
                                        setState(() {
                                          isVisible = !isVisible;
